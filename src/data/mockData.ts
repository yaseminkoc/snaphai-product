...
export const mockConversations: Conversation[] = [
  {
    ...
    messages: [
      ...
      { id: 'm4', role: 'ai', type: 'text', text: '38 beden stoğumuzda mevcut 👍 950 ₺ ne yazık ki belirlenen kâr marjımızın altında kaldığı için mümkün değil; ama sizin için yapabileceğim en iyi fiyat 1.150 ₺. İsterseniz İpek Eşarp’ı da 420 ₺ yerine 380 ₺’ye ekleyip kombininizi tamamlayabiliriz.', createdAt: minAgo(30) },
      { id: 'm5', role: 'customer', type: 'text', text: 'Tamam 1.150’ye alayım, eşarp gerek yok.', createdAt: minAgo(24) },
      { id: 'm6', role: 'ai', type: 'text', text: 'Harika seçim! 🎉 Teslimatı eksiksiz yapabilmem için birkaç bilgi alayım: ad-soyad, telefon ve açık adresiniz yeterli.', createdAt: minAgo(23) },
      { id: 'm7', role: 'customer', type: 'text', text: 'Elif Yıldız, 0532 418 22 05, Caferağa Mah. Moda Cad. No:14 D:6 Kadıköy/İstanbul', createdAt: minAgo(22) },
      { id: 'm8', role: 'system', type: 'text', text: '✓ Teslimat adresi doğrulandı • Kadıköy / İstanbul', createdAt: minAgo(22) },
      { id: 'm9', role: 'ai', type: 'payment-link', text: 'Bilgileriniz eksiksiz. Aşağıdaki güvenli iyzico bağlantısından ödemenizi tamamlayabilirsiniz:', productId: 'p_saten', amount: 1150, paid: true, createdAt: minAgo(21) },
      { id: 'm10', role: 'system', type: 'text', text: 'Ödeme alındı • iyzico • 1.150 ₺', createdAt: minAgo(20) },
      { id: 'm11', role: 'ai', type: 'text', text: 'Ödemeniz alındı, siparişiniz hazırlanıyor 💛 Kargoya verilir verilmez takip numarasını buradan paylaşacağım. Bizi tercih ettiğiniz için teşekkürler Elif Hanım, keyifli günler dilerim!', createdAt: minAgo(19) },
    ],
  },
  {
    id: 'c_mert',
    ...
    status: 'closed-won',
    lastActivity: minAgo(3),
    intent: 'Öğrenci indirimi — Triko Kazak',
    linkedProductId: 'p_triko',
    negotiatedPrice: 621,
    unread: 0,
    messages: [
      { id: 'm1', role: 'customer', type: 'text', text: 'Krem triko kazak var mı? Öğrenciyim, uygun olur mu acaba?', createdAt: minAgo(12) },
      { id: 'm2', role: 'ai', type: 'text', text: 'Merhaba Mert Bey! Krem Triko Kazak stokta 👍 Liste fiyatı 690 ₺. Öğrencilerimize özel %10 indirimle sizin için 621 ₺ olur.', createdAt: minAgo(11) },
      { id: 'm3', role: 'customer', type: 'text', text: 'Süper, M beden var mı peki?', createdAt: minAgo(9) },
      { id: 'm4', role: 'ai', type: 'text', text: 'M beden stoğumuzda mevcut ✔️ Dilerseniz hemen hazırlayayım; teslimat bilgilerinizi (ad-soyad, telefon, açık adres) paylaşırsanız güvenli ödeme bağlantısını oluşturuyorum.', createdAt: minAgo(8) },
      { id: 'm5', role: 'customer', type: 'text', text: 'Mert Kaya, 0541 302 77 019, Tepebaşı Mah. Üniversite Cad. Yıldız Apt. B/14 Eskişehir', createdAt: minAgo(6) },
      { id: 'm6', role: 'system', type: 'text', text: '✓ Teslimat adresi doğrulandı • Tepebaşı / Eskişehir', createdAt: minAgo(6) },
      { id: 'm7', role: 'ai', type: 'payment-link', text: 'Teşekkürler! Öğrenci indiriminiz uygulandı. Güvenli iyzico ödeme bağlantınız hazır:', productId: 'p_triko', amount: 621, paid: true, createdAt: minAgo(5) },
      { id: 'm8', role: 'system', type: 'text', text: 'Ödeme alındı • iyzico • 621 ₺', createdAt: minAgo(4) },
      { id: 'm9', role: 'ai', type: 'text', text: 'Ödemeniz alındı 🎓 Siparişiniz 1 iş günü içinde kargoda olacak. Derslerinizde başarılar dilerim, tekrar bekleriz Mert Bey!', createdAt: minAgo(3) },
    ],
  },
  {
    id: 'c_ayse',
  ...
  },
  {
    ...
    messages: [
      ...
      { id: 'm2', role: 'ai', type: 'voice', text: 'Merhaba Zeynep Hanım! Pudra Şifon Bluz ile Ekru Midi Etek çok uyumlu bir ikili; yumuşak tonlar birbirini tamamlıyor. İkisini birlikte alırsanız kombin indirimiyle 1.320 ₺ yerine 1.190 ₺ yapabilirim. Dilerseniz kombin görselini de gönderebilirim.', transcript: 'Merhaba Zeynep Hanım! Pudra Şifon Bluz ile Ekru Midi Etek çok uyumlu bir ikili; yumuşak tonlar birbirini tamamlıyor. İkisini birlikte alırsanız kombin indirimiyle 1.320 ₺ yerine 1.190 ₺ yapabilirim.', audioDurationSec: 11, createdAt: minAgo(11) },
      { id: 'm3', role: 'customer', type: 'voice', text: '', transcript: 'Çok güzelmiş, ikisini birden alayım o zaman.', audioDurationSec: 4, createdAt: minAgo(8) },
      { id: 'm4', role: 'ai', type: 'text', text: 'Harika seçim! 🌸 Kombininizi 1.190 ₺’ye hazırladım. Teslimat için ad-soyad, telefon ve açık adresinizi paylaşır mısınız?', createdAt: minAgo(7) },
      { id: 'm5', role: 'customer', type: 'text', text: 'Zeynep Ak, 0505 227 60 33, Alsancak Mah. 1453 Sk. No:7 D:3 Konak/İzmir', createdAt: minAgo(5) },
      { id: 'm6', role: 'system', type: 'text', text: '✓ Teslimat adresi doğrulandı • Konak / İzmir', createdAt: minAgo(5) },
      { id: 'm7', role: 'ai', type: 'payment-link', text: 'Bilgileriniz eksiksiz. Güvenli iyzico ödeme bağlantınız hazır:', productId: 'p_sifon', amount: 1190, paid: true, createdAt: minAgo(4) },
      { id: 'm8', role: 'system', type: 'text', text: 'Ödeme alındı • iyzico • 1.190 ₺', createdAt: minAgo(3) },
      { id: 'm9', role: 'ai', type: 'text', text: 'Ödemeniz alındı 💛 Kombininiz özenle hazırlanıp yarın kargoda olacak. Beğeneceğinize eminim; iyi günler dilerim Zeynep Hanım!', createdAt: minAgo(2) },
    ],
  },
  {
    id: 'c_can',
    ...
    messages: [
      ...
      { id: 'm4', role: 'ai', type: 'text', text: 'Teşekkürler! Kayıtlı teslimat adresinize (Çankaya / Ankara) gönderelim mi, yoksa güncellemek ister misiniz?', createdAt: hrAgo(5) },
      { id: 'm5', role: 'customer', type: 'text', text: 'Aynı adres uygun, teşekkürler.', createdAt: hrAgo(5) },
      { id: 'm6', role: 'system', type: 'text', text: '✓ Kayıtlı teslimat adresi kullanılacak • Çankaya / Ankara', createdAt: hrAgo(5) },
      { id: 'm7', role: 'ai', type: 'payment-link', text: 'Güvenli iyzico ödeme bağlantınız hazır:', productId: 'p_kot', amount: 820, paid: true, createdAt: hrAgo(5) },
      { id: 'm8', role: 'system', type: 'text', text: 'Ödeme alındı • iyzico • 820 ₺', createdAt: hrAgo(5) },
      { id: 'm9', role: 'ai', type: 'text', text: 'Ödemeniz alındı 💙 Sadakatiniz için teşekkürler Can Bey; siparişiniz yarın kargoda olacak. Yine bekleriz!', createdAt: hrAgo(5) },
    ],
  },
  {
    id: 'c_selin',
    ...
    status: 'closed-won',
    lastActivity: hrAgo(7),
    intent: 'Sipariş durumu sorgusu — İpek Eşarp',
    linkedProductId: 'p_esarp',
    unread: 0,
    messages: [
      { id: 'm1', role: 'customer', type: 'text', text: 'Merhaba, dün verdiğim siparişim ne durumda acaba?', createdAt: hrAgo(8) },
      { id: 'm2', role: 'ai', type: 'text', text: 'Merhaba Selin Hanım! Siparişinizi kontrol ettim: İpek Eşarp (2 adet) bugün kargoya verildi 📦 Takip numaranız: 1234 5678 9012 (PTT Kargo). Tahmini teslim: yarın 17:00’a kadar.', createdAt: hrAgo(8) },
      { id: 'm3', role: 'customer', type: 'text', text: 'Harika, çok teşekkürler!', createdAt: hrAgo(7) },
      { id: 'm4', role: 'ai', type: 'text', text: 'Rica ederim 💛 Kargonuzu buradan da takip edebilirsiniz; teslimde bir sorun olursa hemen bize yazın. İyi günler dilerim Selin Hanım!', createdAt: hrAgo(7) },
    ],
  },
  {
    id: 'c_deniz',
    ...
    intent: 'İptal + iade — olumsuz deneyim',
    linkedProductId: 'p_triko',
    unread: 1,
    handoffReason: 'Sipariş iptali + olumsuz geri bildirim — itibar riski, insan dokunuşu gerekli',
    messages: [
      { id: 'm1', role: 'customer', type: 'text', text: 'Ürün beklediğim gibi çıkmadı, kumaşı fotoğraftakinden çok ince. Açıkçası hayal kırıklığına uğradım; siparişi iptal edip iade etmek istiyorum.', createdAt: minAgo(9) },
      { id: 'm2', role: 'ai', type: 'text', text: 'Bunu duyduğuma çok üzüldüm Deniz Hanım; yaşadığınız deneyimi önemsiyoruz. İptal ve iade talebinizi oluşturdum, ücret iadeniz başlatıldı. Memnuniyetinizi geri kazanmak istiyoruz — konuyu doğrudan mağaza sorumlumuza ilettim, size özel olarak en kısa sürede dönüş yapılacak.', createdAt: minAgo(8) },
    ],
  },
]
...
export const mockOrders: Order[] = [
  ...
  { id: 'o_4', customerName: 'Deniz Kılıç', customerHandle: '@denizk', productId: 'p_triko', productName: 'Triko Kazak — Krem', productEmoji: '🧥', qty: 1, unitPrice: 621, listPrice: 690, total: 621, status: 'cancelled', channel: 'dm', paymentProvider: 'iyzico', createdAt: hrAgo(11) },
